...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        shader[1].setVec3("light.direction",  sin(lastFrame), cos(lastFrame), -0.99);
        shader[1].setVec3("light.position",0,0,4);
        ...
        shader[1].setFloat("light.quadratic", 0.032f);
        shader[1].setFloat("light.cutOff",glm::cos(glm::radians(12.0)));
        shader[1].setFloat("light.outerCutOff",glm::cos(glm::radians(17.5f)));
