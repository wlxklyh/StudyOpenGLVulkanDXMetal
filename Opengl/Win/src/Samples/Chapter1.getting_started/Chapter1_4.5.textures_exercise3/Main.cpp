...
int main()
{
    ...
    uint32 texture0 = GenerateTexture("resources/textures/container.jpg", GL_RGB, GL_RGB, GL_NEAREST);
    uint32 texture1 = GenerateTexture("resources/textures/awesomeface.png", GL_RGBA, GL_RGBA, GL_NEAREST);

    Shader shader("4.5.vs.glsl","4.5.fs.glsl");
